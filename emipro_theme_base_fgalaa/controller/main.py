...
class EmiproThemeBase(http.Controller):
    ...
    def mega_menu_content_dynamic(self, menu_id):
        response = http.Response(template="emipro_theme_base_fgalaa.website_dynamic_category")
    ...
    def get_quick_view_item(self, product_id=None):
        ...
        if product_id:
            ...
            response = http.Response(template="emipro_theme_base_fgalaa.quick_view_container", qcontext=values)
            return response.render()
    ...
    def get_brand_slider_data(self):
        ...
        """
        response = http.Response(template="emipro_theme_base_fgalaa.brand_slider_container")
        return response.render()
    ...
    def get_category_slider_data(self):
        ...
        """
        response = http.Response(template="emipro_theme_base_fgalaa.category_slider_container")
        return response.render()
    ...
    def slider_preview(self, rec_id, **kwargs):
        ...
        :return:
        """
        return http.Response(template="emipro_theme_base_fgalaa.slider_preview",
    ...
    def get_ajax_cart_item(self, product_id=None):
        ...
        if product_id:
            ...
            response = http.Response(template="emipro_theme_base_fgalaa.ajax_cart_container", qcontext=values)
            return response.render()
    ...
    def get_ajax_cart_sucess(self, product_id=None):
        ...
        if product_id:
            ...
            response = http.Response(template="emipro_theme_base_fgalaa.ajax_cart_success_container", qcontext=values)
            return response.render()
...
class PwaMain(http.Controller):
    ...
    def service_worker(self):
        ...
        content = qweb.render('emipro_theme_base_fgalaa.service_worker', {
            'pwa_cache_name': cache_version + '-pwa_cache-' + str(website_id),
            'website_id': website_id,
        })
        return request.make_response(content, [('Content-Type', mimetype)])

    @route('/pwa_ept_fgalaa/manifest/<int:website_id>', type='http', auth="public", website=True)
    def manifest(self, website_id=None):
        ...
        app_image_48 = "/web/image/website/%s/app_image_512/48x48" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/48x48.png'
        app_image_72 = "/web/image/website/%s/app_image_512/72x72" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/72x72.png'
        app_image_96 = "/web/image/website/%s/app_image_512/96x96" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/96x96.png'
        app_image_144 = "/web/image/website/%s/app_image_512/144x144" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/144x144.png'
        app_image_152 = "/web/image/website/%s/app_image_512/152x152" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/152x152.png'
        app_image_168 = "/web/image/website/%s/app_image_512/168x168" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/168x168.png'
        app_image_192 = "/web/image/website/%s/app_image_512/192x192" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/192x192.png'
        app_image_256 = "/web/image/website/%s/app_image_512/256x256" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/256x256.png'
        app_image_384 = "/web/image/website/%s/app_image_512/384x384" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/384x384.png'
        app_image_512 = "/web/image/website/%s/app_image_512/512x512" % (
            website.id) if website.app_image_512 else '/pwa_ept_fgalaa/static/src/img/512x512.png'

        mimetype = 'application/json;charset=utf-8'
        content = qweb.render('emipro_theme_base_fgalaa.manifest', {
            'pwa_name': pwa_name,
