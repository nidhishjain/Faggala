odoo.define('emipro_theme_base_fgalaa.price_slider', function(require) {
    'use strict';
    ...
    publicWidget.registry.price_slider = publicWidget.Widget.extend({
        ...
        initPriceSlider: function() {
            ...
            $("#ept_price_slider").slider({
                ...
                min:maxValue*-1,
                max:minValue,
                values: [showMaxVal*-1,showMinVal],
        ...
        changeInputVal: function (event) {
            ...
            $("#ept_price_slider").slider("values",  1, $(target).val()*-1);
            }
            if ($(target).data("index")==1)
            {
            $("#ept_price_slider").slider("values",  0, $(target).val()*-1);
            }
